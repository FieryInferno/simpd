...
<div class="box">
  ...
  <div class="box-body">
    <form role="form" enctype ="multipart/form-data" method= "post" action ="<?= base_url('tata_usaha/tata_usaha/edit_spd/' . $id_spd); ?>">
      ...
      <div class="form-group">
        ...
        <select name="kendaraan" class='form-control'>
          ...
          <option value="Kendaraan Pribadi" <?= $kendaraan == 'Kendaraan Pribadi' ? 'selected' : '' ; ?>>Kendaraan Pribadi</option>
          <option value="Kendaraan Umum" <?= $kendaraan == 'Kendaraan Umum' ? 'selected' : '' ; ?>>Kendaraan Umum</option>
        </select>
      </div>
      <div class="form-group">
