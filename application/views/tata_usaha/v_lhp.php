          ...
          <tbody>
            <?php foreach ($lhp->result() as $row) : ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url()."tata_usaha/tata_usaha/lihat_lhp/$row->id_spd"?>" type="button" class="btn btn-success btn-sm" ><i class="fa fa-eye"></i> Detail </a>
                  <a href="<?= base_url()."tata_usaha/tata_usaha/cetak_lhp/$row->id_spd"?>" type="button" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-print"></i> Cetak </a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
